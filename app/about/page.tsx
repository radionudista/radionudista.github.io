...
const texto = `Radio Nudista® es un club social experimental para personas honestas, inclusivas, curiosas y apasionadas. Fundado en 2020, su enfoque se centra en la diversidad de opiniones, ideas y voces. Opera desde Barcelona y São Paulo y se dedica a la producción de eventos conceptuales.
...
Curaduría musical: Lucho Milazzo (@luchomy) y Gustavo Perez (@gustavodesnudo). 
Voces: Diana Hung, Gustavo Perez, Lucho Milazzo, Samira Moura y Gabriel Rodrigues.
Diseño de audio: Manuel Aular @hardlinemanu
Imágenes VHS: @creativecash @maniccarts
Diseño web: Felipe Laboren (xxx@correo.com)
Agradecimientos: David Jimenez, Daniel Villamizar, Clared Navarro, Lemys Kaman, Carlos Segura, Carlos Pinto y Elio Araujo.
`
